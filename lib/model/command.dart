...
class Command extends CommunicationObject {
	...
	Future write_api(dynamic value) {
		...
		return _opendaf.api.writeCommand(this.name, Value.formatAs(value, datatype));
	}

	Future write_ws(dynamic value) {
		String err = validateWrite(value);

		if(err != null)
			return new Future.error(err);

		return _opendaf.ws.writeCommand(this.name, Value.formatAs(value, datatype));
	}
